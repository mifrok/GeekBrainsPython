...
class Road:
    ...
    def asphalt_mass(self, _length, _width, mass, thickness):
        return f'{int(_length * _width * mass * thickness/1000)} т'


new_road = Road(5000, 20)
print(new_road.asphalt_mass(new_road._length, new_road._width, 25, 5))
